...
{
    public class TermBoundedInteger : BoundedInteger<Term<IntegerType>, IntegerType, Term<IntegerType>, IntegerType>
    {
        #region Constructors

        public TermBoundedInteger(Term<IntegerType> lowerBound, Term<IntegerType> upperBound)
            : base(lowerBound, upperBound) { }

        public TermBoundedInteger(Term<IntegerType> lowerBound, int upperBound)
            : base(lowerBound, new IntegerConstant(upperBound)) { }

        public TermBoundedInteger(int lowerBound, Term<IntegerType> upperBound)
