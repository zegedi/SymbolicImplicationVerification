...
{
    public class ConstantBoundedInteger : BoundedInteger<IntegerConstant, Integer, IntegerConstant, Integer>
    {
        #region Constructors
        ...
        public ConstantBoundedInteger(ConstantBoundedInteger constantBoundend)
            : base(new IntegerConstant(constantBoundend.lowerBound), new IntegerConstant(constantBoundend.upperBound)) { }
