using SymImply.Converts;
using SymImply.Implies;
using SymImply.Model;
using System.Text.RegularExpressions;
using System.Windows;
using System.Windows.Forms;

namespace SymImplyGUI
{
    public partial class SymImplyForm : Form
    {
        #region Fields

        private SymImplyModel model;
